 ...
 * @since  1.5
 */
class AuthorModelCategory extends JModelList
{
	/**
	 * Category items data
	 *
	 ...
	 * @var		string
	 */
	protected $_context = 'com_author.category';
	...
	public function getItems()
	{
		...
		{
			$model = JModelLegacy::getInstance('Articles', 'AuthorModel', array('ignore_request' => true));
